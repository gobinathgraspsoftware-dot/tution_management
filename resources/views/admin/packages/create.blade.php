...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        <h1><i class="fas fa-plus me-2"></i> Add New Package</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                ...
                                <option value="offline" {{ old('type') == 'offline' ? 'selected' : '' }}>Offline (Physical)</option>
                                <option value="online" {{ old('type') == 'online' ? 'selected' : '' }}>Online</option>
                                <option value="hybrid" {{ old('type') == 'hybrid' ? 'selected' : '' }}>Hybrid (Both)</option>
                            </select>
                            @error('type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control @error('duration_months') is-invalid @enderror"
                                       ...
                                       value="{{ old('duration_months', 1) }}" min="1" max="24" required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('max_students') is-invalid @enderror"
                                   ...
                                   value="{{ old('max_students') }}" min="1" max="100"
                                   placeholder="e.g., 30">
                            @error('max_students')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" class="form-control form-control-sm sessions-input"
                                                       ...
                                                       value="{{ old('sessions_' . $subject->id, 4) }}"
                                                       min="1" max="30"
                                                       {{ in_array($subject->id, old('subjects', [])) ? '' : 'disabled' }}>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <!-- Online Fee -->
                    <div class="mb-3" id="onlineFeeContainer" style="display: none;">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error('online_fee') is-invalid @enderror"
                                   ...
                                   value="{{ old('online_fee', $defaultOnlineFee) }}"
                    ...
                    <div class="border rounded p-3 bg-light">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <span id="summaryBasePrice">RM 0.00</span>
                        </div>
                        <div class="d-flex justify-content-between" id="summaryOnlineFeeRow" style="display: none;">
                            <span>Online Fee:</span>
                            <span id="summaryOnlineFee">RM 0.00</span>
                        </div>
                        <hr class="my-2">
                        <div class="d-flex justify-content-between">
                            <strong>Total:</strong>
                            <strong class="text-primary" id="summaryTotal">RM 0.00</strong>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" id="includes_materials"
                               ...
                               {{ old('includes_materials') ? 'checked' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    const type = document.getElementById('type').value;
    if (type === 'online' || type === 'hybrid') {
        document.getElementById('onlineFeeContainer').style.display = 'block';
        document.getElementById('summaryOnlineFeeRow').style.display = 'flex';
    }
    updatePriceSummary();
});
</script>

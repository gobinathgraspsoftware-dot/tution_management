...
<div class="page-header">
    <div>
        <h1><i class="fas fa-plus me-2"></i> Add Review</h1>
    ...
    <div class="card-body">
        <form action="{{ route('admin.reviews.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea name="review" class="form-control @error('review') is-invalid @enderror" rows="5" placeholder="Enter the review...">{{ old('review') }}</textarea>
                @error('review')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>

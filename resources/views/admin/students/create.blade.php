                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="registration_type" class="form-select @error('registration_type') is-invalid @enderror" required>
                            <option value="offline" {{ old('registration_type', 'offline') == 'offline' ? 'selected' : '' }}>Offline</option>
                            <option value="online" {{ old('registration_type') == 'online' ? 'selected' : '' }}>Online</option>
                        </select>

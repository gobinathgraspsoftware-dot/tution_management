...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <a href="{{ route('student.enrollments.edit', $enrollment) }}" class="btn btn-primary">
                <i class="fas fa-edit"></i> Edit
            </a>
            @endcan
            <a href="{{ route('student.enrollments.index') }}" class="btn btn-secondary">
...
<div class="modal fade" id="suspendModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('student.enrollments.suspend', $enrollment) }}" method="POST">
                @csrf
                @method('PATCH')
...
<div class="modal fade" id="cancelModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('student.enrollments.cancel', $enrollment) }}" method="POST">
                @csrf
                @method('PATCH')
...
<div class="modal fade" id="renewModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('student.enrollments.renew', $enrollment) }}" method="POST">
                @csrf

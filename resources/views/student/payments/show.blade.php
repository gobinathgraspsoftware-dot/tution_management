    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            @if($payment->status === 'completed')
                <a href="{{ route('student.payments.receipt', $payment) }}" class="btn btn-success" target="_blank">
                    <i class="fas fa-receipt me-1"></i> View Receipt
                </a>
                <a href="{{ route('student.payments.download-receipt', $payment) }}" class="btn btn-info">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-sm mt-4">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{ route('student.payments.history') }}" class="list-group-item list-group-item-action">
